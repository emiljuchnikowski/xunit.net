...
namespace DemoCode.Tests
{
    ...
    public class MemoryCalculatorTests2 : IClassFixture<MemoryCalculatorFixture> // : IDisposable
    {
        ...
        public MemoryCalculatorTests2(ITestOutputHelper helper, MemoryCalculatorFixture fixture)
        {
            _testOutput = helper;
            _fixture = fixture;
